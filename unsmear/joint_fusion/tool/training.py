"""Training, loading, and evaluation loops for baseline, KD, and joint models."""
...
from losses import (
    ...
    teacher_embedding_distance_loss,
...
def initialize_joint_from_baseline(
    ...
    *,
    ...
    # Restore trainability before optionally freezing the backbone up to z.
